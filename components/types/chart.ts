...
export const configSchema = z
  .object({
    ...
    lineCategories: z
      ...
      .optional(),
    colors: z
      .record(z.string().describe('Any of the yKeys'), z.string().describe('Color value in CSS format (hex)'))
      .describe('Mapping of data keys to color values for chart elements'),
    legend: z.boolean().describe('Whether to show legend'),
  })
  .describe('Chart configuration object');

export type ChartConfigFromSchema = z.infer<typeof configSchema>;
